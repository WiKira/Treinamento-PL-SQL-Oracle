...
SELECT NOME FROM TALUNO2
WHERE NOME LIKE '%A%';    --F9

CREATE INDEX IND_TALUNO_NOME2 ON TALUNO2(NOME);

SELECT nome FROM TALUNO
WHERE NOME LIKE '%MA%';   --F9

--
CREATE INDEX IND_TALU_NOMECIDADE2
ON TALUNO2(NOME, CIDADE);

DROP INDEX IND_TALU_NOMECIDADE2;
